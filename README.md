...
- **Combinações** (par, trinca, sequência e cor) também contribuem para a pontuação final.
- É possível **apostar em combinações**, bem como **devolver** um número limitado de cartas.
- Apenas as cartas do jogador são visíveis.
- Não existe a opção **"Seguro"** para o jogador.
...
### Arcanos Maiores
- **Arcanos Maiores** valem **1 ponto** e podem ativar **efeitos especiais** que influenciam a partida:
...
| XIV   | **A Temperança**      | Com moderação, escolha um valor entre 2 e 5 para receber um **debuff** na pontuação.                       | Voluntária |
...
| Combinação           | Requisitos                                      | Bônus de Pontuação | Multiplidor (em aposta) |
| -------------------- | ----------------------------------------------- | ------------------ | ----------------------- |
